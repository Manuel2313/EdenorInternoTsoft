...
public class Utils_Excel {
    ...
    public static void writeCell(File src,String docSheet,int row,int column,String value) throws IOException {
        //carga el archivo
        FileInputStream file = new FileInputStream (src);
        //carga el worlbook
        XSSFWorkbook workbook = new XSSFWorkbook(file);
        //carla la hoja que se quiere modificar o crear
        XSSFSheet sheet = workbook.getSheet(docSheet);
    ...
    public static String readCell(File src, String docSheet, int row, int column) throws IOException {
        FileInputStream file = new FileInputStream (src);
        XSSFWorkbook workbook = new XSSFWorkbook(file);
        XSSFSheet sheet = workbook.getSheet(docSheet);
    ...
    public static void nullCell (File src, String docSheet, int row, int column) throws IOException {
        FileInputStream file = new FileInputStream (src);
        XSSFWorkbook workbook = new XSSFWorkbook(file);
        XSSFSheet sheet = workbook.getSheet(docSheet);
    ...
    public static void copyCell(File src, String docSheet, int originalRow, int originalColumn, int targetRow, int targetColumn) throws IOException {
        String data = readCell(src,docSheet,originalRow,originalColumn);
        writeCell(src,docSheet,targetRow,targetColumn,data);
    }

    public static void removeRow(File src, String docSheet, int row) throws IOException {
        FileInputStream file = new FileInputStream (src);
        XSSFWorkbook workbook = new XSSFWorkbook(file);
        XSSFSheet sheet = workbook.getSheet(docSheet);
    ...
    public static String readCellAndRemoveRow(File src, String docSheet, int row, int column) throws IOException {
