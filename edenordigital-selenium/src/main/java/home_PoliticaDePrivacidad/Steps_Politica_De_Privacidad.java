...
public class Steps_Politica_De_Privacidad extends Steps_PopUp {
    ...
    private By Subtitulos_template = By.xpath("/html/body/div/div[1]/main/div/div[2]/div[2]/div/div[1]/div[3]/div/div");//By.xpath("//span[text()='${texto}']");
    ...
    private void validarSubtitulo(String texto){
        CustomAssert.assertTrue("No se encuentra subtitulo"+texto+"'",driver.findElement(Subtitulos_template).getText().equalsIgnoreCase("texto"));
    }
