...
public class Steps_DatosPersonales extends Steps_Base {
    ...
    private By Button_Editar_Telefono = By.xpath("/html/body/div[1]/div/div[2]/div[4]/div/div[2]/div[4]/button");//By.xpath("//*[text()='Cambiar']");
    ...
    */
    public void clickButtonEditarTelefono(){
        click(Button_Editar_Telefono);
    }
