...
public class Steps_ConfiguracionDeLaCuenta extends Steps_Base {
    ...
    private By buttonAdmDelegaciones = By.xpath("//div[./span[contains(text(),'Delegar cuentas')]]");
    ...
    public void verificarBotonAdmDeDelegaciones(){
        CustomAssert.assertTrue("El usuario no tiene permisos",waitForElementNotPresent(buttonAdmDelegaciones));
    }
